...
- ArozOS desktop chrome is overlaid by
  [`arozos/web-overlays-vanilla/aroz-vanilla-shell.css`](../arozos/web-overlays-vanilla/aroz-vanilla-shell.css);
...
- Shell assets: `arozos/web-overlays-vanilla/` (CSS, taskbar focus JS, desktop icon tooltips, overlay guard); Tango PNGs → `web/img/joshu/` (`arozos/icons/`), `web/img/desktop/` (`arozos/desktop-icons/`), and `web/img/tango/` (full 256×256 library in `arozos/tango-icons/`). Rebuild: [`docs/design/README.md`](design/README.md#tango-icon-pipeline).
