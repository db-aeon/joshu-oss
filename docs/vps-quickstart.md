...
| Release image | `ghcr.io/db-aeon/joshu-oss:0.1.33` (see [`deploy/RELEASE.json`](../deploy/RELEASE.json)) |
...
JOSHU_RELEASE_VERSION=0.1.33
JOSHU_IMAGE_REF=ghcr.io/db-aeon/joshu-oss:0.1.33
JOSHU_VOICE_IMAGE_REF=ghcr.io/db-aeon/joshu-oss-voice-realtime:0.1.33
```
...
To move to a newer image (e.g. `0.1.33`):
