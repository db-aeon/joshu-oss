...
| Release image | `ghcr.io/db-aeon/joshu-oss:0.1.34` (see [`deploy/RELEASE.json`](../deploy/RELEASE.json)) |
...
JOSHU_VOICE_IMAGE_REF=ghcr.io/db-aeon/joshu-oss-voice-realtime:0.1.34
```
...
To move to a newer image (e.g. `0.1.34`):
