/** Desktop presentation — open ArozOS modules and files from jChat (text + voice). */
...
/** Spoken / colloquial aliases → moduleInfo.json Name */
...
/** Tier-1 typed shortcut: "open the mail app", "open jWeb", … */
