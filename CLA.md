...
**"Contribution"** means any code, documentation, or other material you submit
to the Joshu open-source repository via pull request or similar mechanism.
...
You grant Us a perpetual, worldwide, non-exclusive, no-charge, royalty-free,
irrevocable patent license to make, use, sell, offer for sale, import, and
...
You understand that the decision to include any Contribution is at Our sole
discretion and that this Agreement does not create any obligation to use your
Contribution.

---

By signing the CLA via the GitHub CLA Assistant bot, you accept this Agreement.
